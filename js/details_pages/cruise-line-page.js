$(function () {  
    ...
    $(".cruise-line-page .cruise-tabs .tab-content .custom-content").css({display: "block"});
    /********Start Header Tabs ********/
    ...
    $(window).on("load resize", function () {  
        ...
        //Header Height
        var navbarHeight = $(".cruise-line-page .navbar").innerHeight(),
        upperbarHeight = $(".cruise-line-page .upper-bar").innerHeight(),
        allHeight = navbarHeight + upperbarHeight;
        $(".cruise-line-page .cruise-details-header").css({
            height: "calc( 100vh - " + allHeight + "px )"
        });
        //slide-content height
        $(".cruise-line-page .cruise-details-header .slide-content").css({
            height: "calc( 100% - " + ( $(".cruise-line-page .cruise-tabs .custom-nav-tabs").innerHeight() + 10) + "px )"
        });
        //Move Tabs To up 
        $(".cruise-line-page .cruise-tabs").css({
            transform: "translateY(-"+ $(".cruise-line-page .cruise-tabs .all-tabs").innerHeight() +"px)"
        });
        /******** End Header Tabs ********/
    ...
    $(".cruise-line-page .cruise-tabs .custom-nav-tabs .custom-nav-item").on("click", function () {  
    ...
    $(".cruise-line-page .cruise-tabs .tab-content .staterooms-content .stateroom-tabs .swiper-slide").on("click", function () {
    ...
    $(".cruise-line-page .cruise-tabs .tab-content .main-staterooms .main-card .card .card-body .arrows .arrow-down").on("click", function () {  
    ...
    $(".cruise-line-page .itinerary-content .main-table .table-right-arrow").on("click", function () {
        $(this).parents(".main-table").find(".table-res").animate({  
            scrollLeft : $(this).parents(".main-table").find(".table-res").scrollLeft() + 100
        }, 200);
    });
    $(".cruise-line-page .itinerary-content .main-table .table-left-arrow").on("click", function () {  
        $(this).parents(".main-table").find(".table-res").animate({  
            scrollLeft : $(this).parents(".main-table").find(".table-res").scrollLeft() - 100
        }, 200);
    });
    
    $(".cruise-line-page .itinerary-content .arrow").on("click", function () {  
        $(this).toggleClass("reversed");
        $(this).parents(".card_info").find(".card-details").slideToggle(200);
    });

    //accordion [cruise-details .accordion-list]
    $(".cruise-line-page .itinerary-content .card-details .cruise-details .accordion-list .accordion-item .accordion-item-head .accordion-arrow").on("click", function () {  
    ...
    /******* entertainment *****/
    /*******************/
    $(".cruise-line-page .entertainment-content .card_info .main-card .entertainment-arrow").on("click", function () {  
    ...
    $(".cruise-line-page .activities-content .main-imgs img.active").show().siblings().hide(); 
    $(".cruise-line-page .activities-content .content.active").show().siblings().hide(); 
    ...
    $(".cruise-line-page .activities-content .gallery-list .gallery-list_item").on("click", function () {  
        triggerGalleryImgs(this);
    });



    $(".cruise-line-page .activities-content .card_info .main-card .activities-arrow").on("click", function () {  
        var card_info = $(this).parents(".card_info"),
            card_details = card_info.find(".card-details");
        $(this).toggleClass("reversed");
        card_details.slideToggle(200);
    ...
    /******* excursions *****/
    /*******************/
    $(".cruise-line-page .excursions-content .card_info .main-card .excursions-arrow").on("click", function () {  
        var card_info = $(this).parents(".card_info"),
            card_details = card_info.find(".card-details");
        $(this).toggleClass("reversed");
        card_details.slideToggle(200);
    ...
    $(window).on("load resize", function () {  
        ...
        let overviewGalleryThumbs = new Swiper('.cruise-line-page .overview-content .gallery-thumbs', {
        ...
        let overviewGalleryTop = new Swiper('.cruise-line-page .overview-content .gallery-top', {
            spaceBetween: 10,
            navigation: {
              nextEl: '.cruise-line-page .overview-content .swiper-button-next',
              prevEl: '.cruise-line-page .overview-content .swiper-button-prev',
            },
            thumbs: {
    ...
    $(window).on("load", function () {  
        $(".cruise-line-page .cruise-tabs .tab-content .custom-content.active").show().siblings().hide();
    });
