$(function () {  
    ...
    let offerContentTabSwiper = new Swiper('.offer-list-page-content .swiper-container', {
      spaceBetween: 0,
      slidesPerGroup: 1,
      loop: false,
      ...
      navigation: {
        nextEl: '.offer-list-page-content .swiper-button-next',
        prevEl: '.offer-list-page-content .swiper-button-prev',
      },
      breakpoints: {
        0: {
          slidesPerView: 2
    ...
    $(".offer-list-page-content .custom-tab-content .custom-content.active").show().siblings().hide();
    $(".offer-list-page-content .custom-nav-tabs .custom-nav-item").on("click", function () {  
      activeTabContent(this);
    });
    function activeTabContent($this) {  
      
      let dataTabContent = $($this).data("tab-content"),
          customContent = $(".offer-list-page-content .custom-tab-content").find(dataTabContent);
